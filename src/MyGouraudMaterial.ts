...
export class MyGouraudMaterial extends gfx.Material3
{
    ...
    constructor()
    {
        ...
        this.textureUniform = MyGouraudMaterial.shader.getUniform(this.gl, 'surfaceTexture');
        ...
        this.ambientIntensitiesUniform = MyGouraudMaterial.shader.getUniform(this.gl, 'lightAmbientIntensities');
        this.diffuseIntensitiesUniform = MyGouraudMaterial.shader.getUniform(this.gl, 'lightDiffuseIntensities');
        this.specularIntensitiesUniform = MyGouraudMaterial.shader.getUniform(this.gl, 'lightSpecularIntensities');

        this.positionAttribute = MyGouraudMaterial.shader.getAttribute(this.gl, 'positionModel');
        this.normalAttribute = MyGouraudMaterial.shader.getAttribute(this.gl, 'normalModel');
        this.colorAttribute = MyGouraudMaterial.shader.getAttribute(this.gl, 'color');
        this.texCoordAttribute = MyGouraudMaterial.shader.getAttribute(this.gl, 'texCoords');   
    }
    ...
    draw(mesh: gfx.Mesh3, camera: gfx.Camera, lightManager: gfx.LightManager): void
    {
        ...
        const normalMatrix = modelMatrix.getInverse().getTranspose();
